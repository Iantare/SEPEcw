                        ...
                        <tbody><!-- tbody Begin-->
                          ...
                          <?php
                           ...
                           <tr><!-- tr Begin-->
                             ...
                             <td>
                                <img class="img-responsive" src="admin_area/product_images/<?php echo $Prod_img1; ?>" alt="Product 2">
                             </td>
          ...
          <div class='col-md-3 col-sm-6 center-responsive'><!-- col-md-3 col-sm-6 center-responsive Begin -->
              ...
              <div class='product same-height'><!-- product same-height Begin-->
                <a href='details.php?Prod_id=$Prod_id'>
                  <img class='img-responsive' src='admin_area/product_images/$Prod_img1' alt='Product 2'>
                </a>
